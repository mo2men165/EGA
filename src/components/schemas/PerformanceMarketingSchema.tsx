// components/PerformanceMarketingSchema.tsx
'use client';
...
const PerformanceMarketingSchema = () => {
  const t = useTranslations('performanceMarketingPage');
  ...
  useEffect(() => {
    try {
      ...
      const serviceSchema = {
        ...
        "audience": {
          "@type": "Audience",
          "audienceType": "Businesses seeking data-driven marketing strategies"
        }
      };
      ...
      console.error('Error creating performance marketing schema:', error);
    }
  }, [t]);
...
export default PerformanceMarketingSchema;