            ...
            <div className="flex flex-col justify-between space-y-6 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <motion.a href="https://www.facebook.com/egamarketingagency" className="text-gray-600 transition-colors hover:text-lime-500 dark:text-gray-400 dark:hover:text-lime-400" whileHover={{ y: -3 }}>
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
                    </svg>
                  </motion.a>
                  <motion.a href="https://www.instagram.com/egamarketingagency/" className="text-gray-600 transition-colors hover:text-lime-500 dark:text-gray-400 dark:hover:text-lime-400" whileHover={{ y: -3 }}>
                    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <motion.a href="https://www.tiktok.com/@egamarketingagency" className="text-gray-400 transition duration-300 hover:text-lime-500">
