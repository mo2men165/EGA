      ...
      <div className="container mx-auto px-4">
        ...
        >
          {[0, 1, 2].map((index) => (
            ...
            >
              {/* Decorative element */}
              <div className="absolute -right-8 -top-8 w-24 h-24 rounded-full bg-rose-100 dark:bg-rose-900/20 opacity-50"></div>
              
              <motion.div 
                className="w-16 h-16 bg-rose-100 dark:bg-rose-900/30 rounded-xl flex items-center justify-center mb-6 relative z-10 text-rose-600 dark:text-rose-400"
