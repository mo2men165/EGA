        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 w-full">
            ...
            >
              ...
              <motion.span 
                className="mt-2 sm:mt-3 block bg-gradient-to-r from-lime-500 via-lime-600 to-teal-600 bg-clip-text text-transparent dark:from-lime-400 dark:via-lime-500 dark:to-teal-400"
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex">
                          ...
                          <span className="pl-2 sm:pl-4 text-lime-400">return</span>
                          <span className="text-white"> (</span>
                        </div>
                        <div className="flex">
