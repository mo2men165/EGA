...
const MediaProductionOverview: React.FC = () => {
  const t = useTranslations('mediaProductionPage.overview');
        ...
        >
          {[0, 1, 2].map((index) => (
            ...
            >
              ...
              <motion.div 
                className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center mb-6 relative z-10 text-blue-600 dark:text-blue-400"
...
export default MediaProductionOverview;