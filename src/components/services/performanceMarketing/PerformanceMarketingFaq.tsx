...
const PerformanceMarketingFaq: React.FC = () => {
  const t = useTranslations('performanceMarketingPage.faq');
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              href="#contact"
              className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-amber-600 border border-transparent rounded-xl shadow-lg hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors duration-300 w-full sm:w-auto"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <svg 
...
export default PerformanceMarketingFaq;